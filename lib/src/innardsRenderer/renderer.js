...
function exploreLeftUntilRenderRightFromBlock(svg, b, grid, openModal) {
    ...
    let lowestDependencyY = b.inputs.length ? Math.min.apply(null, b.inputs.map((v) => v.rendering.y)) : 0;
    console.log("rendering block", b, "got lowest dependency y", lowestDependencyY);
